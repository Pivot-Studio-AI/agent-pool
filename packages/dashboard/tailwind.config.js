  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 1px 2px rgba(0, 0, 0, 0.08), 0 0 0 1px var(--color-border)',
        'card-hover': '0 8px 24px rgba(0, 0, 0, 0.16), 0 0 0 1px var(--color-border)',
        'elevated': '0 4px 16px rgba(0, 0, 0, 0.12), 0 0 0 1px var(--color-border)',
